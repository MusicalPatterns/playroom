...
const onlyThatOneFieldOfTheArrayedSpecControlIsModified: () => Promise<void> =
    async (): Promise<void> => {
        expect(await elementInnerText(`#${ARRAYED_PROPERTY_KEY}-0 .${SecretSelectorsForTest.SECRET_SUBMITTED_SPEC}`))
            .toBe(
        ...
        expect(await elementInnerText(`#${ARRAYED_PROPERTY_KEY}-1 .${SecretSelectorsForTest.SECRET_SUBMITTED_SPEC}`))
            .toBe(
        ...
        expect(await elementInnerText(`#${ARRAYED_PROPERTY_KEY}-2 .${SecretSelectorsForTest.SECRET_SUBMITTED_SPEC}`))
            .toBe(
        ...
        expect(await elementInnerText(`#${ARRAYED_PROPERTY_KEY}-3 .${SecretSelectorsForTest.SECRET_SUBMITTED_SPEC}`))
            .toBe(
        ...
        expect(await elementInnerText(`#${ARRAYED_PROPERTY_KEY}-4 .${SecretSelectorsForTest.SECRET_SUBMITTED_SPEC}`))
            .toBe(
