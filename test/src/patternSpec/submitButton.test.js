...
describe('submit button', () => {
    ...
    it('enables the submit button for a pattern spec input after you type anything', async done => {
        expect(await elementExists(`button#${PATTERN_SPEC_CONTINUOUS_PROPERTY_ONE_KEY}:disabled`))
            .toBeTruthy()
        ...
        expect(await elementExists(`button#${PATTERN_SPEC_CONTINUOUS_PROPERTY_ONE_KEY}:enabled`))
            .toBeTruthy()
    ...
    describe('the same is true of discrete types', () => {
        it('enables the submit button for a pattern spec input after you change it', async done => {
            expect(await elementExists(`button#${PATTERN_SPEC_DISCRETE_PROPERTY_ONE_KEY}:disabled`))
                .toBeTruthy()
            ...
            expect(await elementExists(`button#${PATTERN_SPEC_DISCRETE_PROPERTY_ONE_KEY}:enabled`))
                .toBeTruthy()
        ...
        it('resets the submit button to disabled when you click it', async done => {
            ...
            const button = await findElement(testGlobals.tab, `button#${PATTERN_SPEC_DISCRETE_PROPERTY_ONE_KEY}`)
            await clickElement(button)
