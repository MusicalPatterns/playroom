...
describe('reset button', () => {
    ...
    it('resets the pattern spec to the pattern\'s defaults', async done => {
        ...
        const inputTwo = await findElement(testGlobals.tab, `input#${PATTERN_SPEC_CONTINUOUS_PROPERTY_TWO_KEY}`)
    ...
    it('if there were any unsubmitted inputs, they no longer appear as unsubmitted', async done => {
        const inputToBeUnsubmitted = await findElement(testGlobals.tab, `input#${PATTERN_SPEC_CONTINUOUS_PROPERTY_ONE_KEY}`)
        ...
        const inputToBeSubmittedSuchThatResetButtonIsEnabled = await findElement(testGlobals.tab, `input#${PATTERN_SPEC_CONTINUOUS_PROPERTY_TWO_KEY}`)
    ...
    it('if there were any invalid inputs, they no longer appear as invalid', async done => {
        const inputToBeInvalid = await findElement(testGlobals.tab, `input#${PATTERN_SPEC_CONTINUOUS_PROPERTY_ONE_KEY}`)
