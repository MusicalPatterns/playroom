...
const SPEC_RANGED_PROPERTY_ONE_KEY = StandardSpecProperties.BASE_DURATION
const SPEC_RANGED_PROPERTY_TWO_KEY = StandardSpecProperties.BASE_FREQUENCY
...
const SPEC_ARRAYED_PROPERTY_KEY = 'arrayOfRangedProperty'
...
const SPEC_CONTROLS_PATTERN_ARRAYED_PROPERTY_INITIAL_VALUE = playroomTestSpecControls.specData.initial[ SPEC_ARRAYED_PROPERTY_KEY ]

const POST_PATTERN_ID = playroomTestPost.id
const POST_PATTERN_TITLE = playroomTestPost.metadata.formattedName
const POST_PATTERN_RANGED_PROPERTY_ONE_INITIAL_VALUE = playroomTestPost.specData.initial[ SPEC_RANGED_PROPERTY_ONE_KEY ]
const POST_PATTERN_RANGED_PROPERTY_TWO_INITIAL_VALUE = playroomTestPost.specData.initial[ SPEC_RANGED_PROPERTY_TWO_KEY ]
const POST_PATTERN_OPTIONED_PROPERTY_ONE_INITIAL_VALUE = playroomTestPost.specData.initial[ SPEC_OPTIONED_PROPERTY_ONE_KEY ]
const POST_PATTERN_OPTIONED_PROPERTY_ONE_MODIFIED_VALUE = playroomTestPost.specData.attributes[ SPEC_OPTIONED_PROPERTY_ONE_KEY ].constraint[ 1 ].key
const POST_PATTERN_OPTIONED_PROPERTY_TWO_INITIAL_VALUE = playroomTestPost.specData.initial[ SPEC_OPTIONED_PROPERTY_TWO_KEY ]
const POST_PATTERN_OPTIONED_PROPERTY_TWO_MODIFIED_VALUE = playroomTestPost.specData.attributes[ SPEC_OPTIONED_PROPERTY_TWO_KEY ].constraint[ 0 ].key
