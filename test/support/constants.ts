...
import { as, Ms, ObjectOf } from '@musical-patterns/utilities'
// @ts-ignore
...
const LONG_ENOUGH_FOR_TIME_TO_PASS: Ms = as.Ms(100)
const LONG_ENOUGH_FOR_TIME_TO_HAVE_BEEN_RESET: Ms = as.Ms(200)
const A_BIT_LONGER: Ms = as.Ms(1000)
const EVEN_A_BIT_LONGER: Ms = as.Ms(2000)
