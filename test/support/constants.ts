...
import { as, Ms, ObjectOf, Translation } from '@musical-patterns/utilities'
// @ts-ignore
...
const LONG_ENOUGH_FOR_TIME_TO_PASS: Translation<Ms> = as.Translation<Ms>(100)
const LONG_ENOUGH_FOR_TIME_TO_HAVE_BEEN_RESET: Translation<Ms> = as.Translation<Ms>(200)
const A_BIT_LONGER: Translation<Ms> = as.Translation<Ms>(1000)
const EVEN_A_BIT_LONGER: Translation<Ms> = as.Translation<Ms>(2000)
