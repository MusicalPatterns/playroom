...
const SPEC_CONTROLS_PATTERN_ARRAYED_PROPERTY_INITIAL_VALUE: string = playroomTestSpecControls.specData.initial[ SPEC_ARRAYED_PROPERTY_KEY ]
...
const DEFAULT_VIEWPORT_WIDTH: number = 1600
