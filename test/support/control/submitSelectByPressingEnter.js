...
import { PATTERN_SPEC_OPTIONED_PROPERTY_ONE_KEY } from '../constants'
import { press } from './keyboard'

const submitSelectByPressingEnter = async () => {
    const select = await findElement(testGlobals.tab, `select#${PATTERN_SPEC_OPTIONED_PROPERTY_ONE_KEY}`)
